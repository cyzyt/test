...
ssrObjCfg.SYHDPagingGemstoneObj = {
  ID           = 90100,
  OBJ_ORDER    = { ssrObjCfg.ShangYeHuoDong7, ssrObjCfg.SevenDaySignin, ssrObjCfg.ShangYeHuoDong2,
    ssrObjCfg.ShangYeHuoDong3, ssrObjCfg.ShangYeHuoDong4, ssrObjCfg.ShangYeHuoDong5, ssrObjCfg.ShangYeHuoDong6, },
  OBJ_DESCRIBE = { "每日充值", "七日登陆", "限时直购", "累计充值", "行会竞技", "首爆奖励",
    "全服回收", },
  OBJ_TITLE    = { "开服活动" },
  RP_EVENT     = ssrEventCfg.RpPagingGemstone,
