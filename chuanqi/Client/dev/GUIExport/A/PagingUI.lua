...
function ui.init(parent)
	...
	-- Create btn_template
	local btn_template = GUI:Button_Create(Page_Layer, "btn_template", 1186.00, 503.00, "res/custom/common/btn_3_1.png")
	GUI:Button_loadTexturePressed(btn_template, "res/custom/common/btn_3_1.png")
	GUI:Button_loadTextureDisabled(btn_template, "res/custom/common/btn_3_2.png")
	GUI:Button_setScale9Slice(btn_template, 15, 15, 11, 11)
	GUI:setContentSize(btn_template, 154, 42)
	GUI:setIgnoreContentAdaptWithSize(btn_template, false)
	...
	GUI:setAnchorPoint(btn_template, 0.00, -0.70)
	GUI:setScaleY(btn_template, 0.94)
	GUI:setTouchEnabled(btn_template, true)
	GUI:setTag(btn_template, 704)

	-- Create img_red_point
	local img_red_point = GUI:Image_Create(btn_template, "img_red_point", 143.00, 31.00, "res/custom/common/img_2.png")
	GUI:setAnchorPoint(img_red_point, 0.50, 0.50)
	GUI:setTouchEnabled(img_red_point, false)
	GUI:setTag(img_red_point, 450)

	-- Create Text
	local Text = GUI:Text_Create(btn_template, "Text", 77.00, 21.00, 19, "#ffffff", [[文本]])
	...
	-- Create ListView
	local ListView = GUI:ListView_Create(img_bg, "ListView", 82.00, 37.00, 155.00, 430.00, 1)
