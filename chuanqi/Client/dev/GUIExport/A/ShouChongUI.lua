...
function ui.init(parent)
	...
	-- Create bg_close
	local bg_close = GUI:Layout_Create(Layer, "bg_close", -1.00, -1.00, 1136.00, 640.00, false)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(img_bg, "Panel_1", 168.00, 462.00, 500.00, 90.00, true)
	...
	-- Create img_title
	local img_title = GUI:Image_Create(Panel_1, "img_title", 264.00, -131.00, "res/custom/shouchong/img_1.png")
	GUI:setAnchorPoint(img_title, 0.50, 0.50)
	GUI:setTouchEnabled(img_title, false)
	GUI:setTag(img_title, 582)

	-- Create Panel_2
	local Panel_2 = GUI:Layout_Create(img_bg, "Panel_2", 214.00, 383.00, 400.00, 130.00, true)
	...
	-- Create img_title
	local img_title = GUI:Image_Create(Panel_2, "img_title", 217.00, -11.00, "res/custom/shouchong/img_1.png")
	GUI:setAnchorPoint(img_title, 0.50, 0.50)
	GUI:setTouchEnabled(img_title, false)
	GUI:setTag(img_title, 2070)

	-- Create Button_1
	local Button_1 = GUI:Button_Create(img_bg, "Button_1", 491.00, 89.00, "res/custom/shouchong/btn_shouchong_04.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(img_bg, "Button_2", 491.00, 89.00, "res/custom/shouchong/btn_shouchong_05.png")
	...
	-- Create Button_3
	local Button_3 = GUI:Image_Create(img_bg, "Button_3", 491.00, 91.00, "res/custom/common/com_txt_ylq2.png")
	GUI:setAnchorPoint(Button_3, 0.50, 0.50)
	GUI:setTouchEnabled(Button_3, false)
	GUI:setTag(Button_3, 2175)

	-- Create btn_close
	local btn_close = GUI:Button_Create(img_bg, "btn_close", 773.00, 419.00, "res/custom/common/btn_close_1_1.png")
	...
	-- Create btn_day_1
	local btn_day_1 = GUI:Button_Create(img_bg, "btn_day_1", 732.00, 350.00, "res/custom/shouchong/btn_day_1_1.png")
	...
	-- Create redPonit_1
	local redPonit_1 = GUI:Image_Create(btn_day_1, "redPonit_1", 122.00, 35.00, "res/custom/common/img_2.png")
	...
	-- Create btn_day_2
	local btn_day_2 = GUI:Button_Create(img_bg, "btn_day_2", 676.00, 301.00, "res/custom/shouchong/btn_day_2_1.png")
	...
	-- Create redPonit_2
	local redPonit_2 = GUI:Image_Create(btn_day_2, "redPonit_2", 122.00, 35.00, "res/custom/common/img_2.png")
	...
	-- Create btn_day_3
	local btn_day_3 = GUI:Button_Create(img_bg, "btn_day_3", 676.00, 249.00, "res/custom/shouchong/btn_day_3_1.png")
	...
	-- Create redPonit_3
	local redPonit_3 = GUI:Image_Create(btn_day_3, "redPonit_3", 122.00, 35.00, "res/custom/common/img_2.png")
	...
	-- Create item_list
	local item_list = GUI:ListView_Create(img_bg, "item_list", 510.00, 206.00, 450.00, 60.00, 2)
	...
	-- Create texiao
	local texiao = GUI:Layout_Create(img_bg, "texiao", -95.00, 58.00, 200.00, 400.00, false)
	...
	-- Create ScrollView
	local ScrollView = GUI:ScrollView_Create(Layer, "ScrollView", 265.00, 147.00, 200.00, 200.00, 1)
	...
	-- Create Text
	local Text = GUI:Text_Create(ScrollView, "Text", 0.00, 0.00, 16, "#ffffff", [[文本]])
	GUI:setTouchEnabled(Text, false)
	GUI:setTag(Text, -1)
	GUI:Text_enableOutline(Text, "#000000", 1)

	-- Create ImageView
	local ImageView = GUI:Image_Create(ScrollView, "ImageView", 468.00, 125.00, "res/private/gui_edit/ImageFile.png")
	GUI:setTouchEnabled(ImageView, false)
	GUI:setTag(ImageView, -1)

	-- Create Button
	local Button = GUI:Button_Create(ScrollView, "Button", 462.00, 4.00, "res/private/gui_edit/Button_Normal.png")
