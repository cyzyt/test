...
function ui.init(parent)
	...
	-- Create nd_root
	local nd_root = GUI:Layout_Create(Layer, "nd_root", 568.00, 320.00, 0.00, 0.00, false)
	GUI:setAnchorPoint(nd_root, 0.50, 0.50)
	GUI:setTouchEnabled(nd_root, true)
	...
	-- Create tx_title
	local tx_title = GUI:Text_Create(img_bg, "tx_title", 112.00, 509.00, 20, "#d6c6ad", [[弑神套装锻造]])
	...
	-- Create ListView_2
	local ListView_2 = GUI:ListView_Create(nd_root, "ListView_2", -231.00, 168.00, 620.00, 380.00, 1)
	...
	-- Create itemBg
	local itemBg = GUI:Image_Create(img_1, "itemBg", 58.00, 90.00, "res/custom/common/img_cell_1.png")
	...
	-- Create itemBg
	local itemBg = GUI:Image_Create(img_2, "itemBg", 58.00, 90.00, "res/custom/common/img_cell_1.png")
	GUI:setContentSize(itemBg, 50, 50)
	GUI:setIgnoreContentAdaptWithSize(itemBg, false)
	GUI:setAnchorPoint(itemBg, 0.50, 0.50)
	GUI:setTouchEnabled(itemBg, false)
	...
	-- Create template
	local template = GUI:Button_Create(nd_root, "template", 67.00, 418.00, "res/custom/common/btn_3_1.png")
