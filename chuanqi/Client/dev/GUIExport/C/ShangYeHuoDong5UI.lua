...
function ui.init(parent)
	...
	-- Create View_huadong
	local View_huadong = GUI:ListView_Create(img_di, "View_huadong", 156.00, 1.00, 580.00, 400.00, 1)
	...
	-- Create cell
	local cell = GUI:ListView_Create(nd_root, "cell", -11.00, 320.00, 580.00, 60.00, 1)
	...
	GUI:Layout_setBackGroundColor(template, "#ff00ff")
